class Endpoints {
  ...
  static String accountTransactions(String id) => '/api/v1/accounts/$id/transactions';
  static String recalculateBalance(String id) => '/api/v1/accounts/$id/recalculate';
  ...
  static String transactionComments(String id) => '/api/v1/transactions/$id/comments';
  static String transactionComment(String txId, String commentId) =>
      '/api/v1/transactions/$txId/comments/$commentId';
  static String categorizeTransaction(String id) => '/api/v1/transactions/$id/categorize';
  ...
  static const String analyticsRefreshForecast = '/api/v1/analytics/forecast/refresh';
}
